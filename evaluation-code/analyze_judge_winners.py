...
# Read the JSONL file
data = []
with open('/dccstor/gma2/jhjenny9/counterfactual_feedback/route-to-reasoning-data/evaluation_predictions_with_gpt4o_judged.jsonl', 'r') as f:
    for line in f:
...
ax1.set_title('Overall Judge Winner Distribution', fontsize=14, fontweight='bold')
ax1.set_ylabel('')
...
ax2.set_title('Judge Winner Distribution by Turn', fontsize=14, fontweight='bold')
...
ax3.set_title('Win Percentage by Turn', fontsize=14, fontweight='bold')
...
ax4.set_title('Win Percentage by Confidence Level', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/dccstor/gma2/jhjenny9/counterfactual_feedback/judge_winner_analysis.png', dpi=300, bbox_inches='tight')
print(f"\n\nVisualization saved to: judge_winner_analysis.png")
